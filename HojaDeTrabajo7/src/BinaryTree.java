...
public class BinaryTree<E> {
    ...
    private Node insertElement(Node current, E value) {
        /**
         * ets the String associates with the object to be introduced
         */
    ...
    /**
     * Inserts an element to the binary tree; calls the recursive method so that
